      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-xl mx-auto relative">
          ...
          {/* <p className="text-center text-gray-400 text-sm">
            By connecting, you agree to our <a href="#" className="text-purple-400 hover:underline">Privacy Policy</a> and <a href="#" className="text-purple-400 hover:underline">Terms of Service</a>
          </p> */}
        </div>
      </div>
    </div>
